...
def main_markup() -> ReplyKeyboardMarkup:
    menu_buttons = [
        ...
        "Об эстафете ГДД",
        "Сдать сводку",
        "Коэффициенты умножения муниципальных образований",
        "Рейтинг эстафеты",
        "Документы",
        "Регистрация в ГДД",
...
def second_menu_markup() -> ReplyKeyboardMarkup:
    menu_buttons = [
        ...
        "Участники эстафеты",
        "Ростики. Пункты. Коэффициенты умножения",
        "Метрика. Учёт Мероприятий, Ростиков, Пунктов и Добрых Дел.",
        "Наглядный пример учёта всех пользователей",
        "Формирование рейтингов игроков. Награждение. Панель Рейтинга. ",
        "Хештеги ГДД",
