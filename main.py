...
messages = {
    ...
    "Коэффициенты умножения муниципальных образований": {"text": "[Коэффициенты умножения муниципальных образований](https://clck.ru/39QoNo)","photo": "./коэфф.PNG", "markup": fourth_menu_markup()},
